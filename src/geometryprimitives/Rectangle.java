...
public class Rectangle {
    ...
    public Rectangle(Point upperLeft, double width, double height) {
        this.edges[this.UPPER_EDGE] = new Line(upperLeft, new Point(upperLeft.getX() + width, upperLeft.getY()));
        this.edges[this.LOWER_EDGE] = new Line(upperLeft.getX(), upperLeft.getY() + height, upperLeft.getX() + width,
                                               upperLeft.getY() + height);
        this.edges[this.LEFT_EDGE] = new Line(upperLeft, new Point(upperLeft.getX(), upperLeft.getY() + height));
        this.edges[this.RIGHT_EDGE] = new Line(upperLeft.getX() + width, upperLeft.getY(), upperLeft.getX() + width,
                                               upperLeft.getY() + height);
    ...
    public List<Point> intersectionPoints(Line line) {
        ...
        if (inRectangle(line.start())) {
            list.add(line.start());
        }

        if (inRectangle(line.end())) {
            list.add(line.end());
        }
     ...
     * @return true if the point is in this rectangle and false it is not.
     */
    private boolean inRectangle(Point point) {
        return point.getX() >= this.getUpperLeft().getX() && point.getX() <= this.getLowerRight().getX() && point
                .getY() >= this.getUpperLeft().getY() && point.getY() <= this.getLowerRight().getY();
    }
    /**
    ...
    public Line getUpperEdge() {
        return new Line(this.edges[this.UPPER_EDGE].start(), this.edges[this.UPPER_EDGE].end());
    }
    /**
     * Get the lower edge.
     *
    ...
    public Line getLowerEdge() {
        return new Line(this.edges[this.LOWER_EDGE].start(), this.edges[this.LOWER_EDGE].end());
    }
    /**
     * Get the right edge.
     *
    ...
    public Line getRightEdge() {
        return new Line(this.edges[this.RIGHT_EDGE].start(), this.edges[this.RIGHT_EDGE].end());
    }
    /**
     * Get the left edge.
     *
    ...
    public Line getLeftEdge() {
        return new Line(this.edges[this.LEFT_EDGE].start(), this.edges[this.LEFT_EDGE].end());
    }
    /**
    ...
    public boolean isPointOnCorner(Point p) {
        if ((p.equals(this.getUpperLeft())) || (p.equals(this.getUpperRight())) || (p.equals(
                this.getLowerLeft())) || (p.equals(this.getLowerRight()))) {
            return true;
        }
        return false;
    }
    ...
    public void updateEdgesAccordingToUpperLeft() {
        this.edges[this.UPPER_EDGE] = new Line(this.getUpperLeft(), this.getUpperRight());
        this.edges[this.LOWER_EDGE] = new Line(this.getLowerLeft(), this.getLowerRight());
        this.edges[this.LEFT_EDGE] = new Line(this.getUpperLeft(), this.getLowerLeft());
        this.edges[this.RIGHT_EDGE] = new Line(this.getUpperRight(), this.getLowerRight());
    }
    /**
    ...
    /**
     * Set new upper left Y.
     *
     * @param newY new Y.
     */
    public void setYUpperLeft(double newY) {
        double oldX = this.getUpperLeft().getX();
        this.setUpperLeft(new Point(oldX, newY));
    }
}
